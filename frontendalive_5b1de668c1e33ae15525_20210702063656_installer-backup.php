...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'frontendalive_5b1de668c1e33ae15525_20210702063656_archive.zip';
	const ARCHIVE_SIZE		 = '39027903';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '5b1de66-02063656';
    const SECONDARY_PACKAGE_HASH = '79761b7-02063656';
	const VERSION			 = '1.4.1';
